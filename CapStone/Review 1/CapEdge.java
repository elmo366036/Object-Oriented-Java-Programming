...
class CapEdge
{
     ...
     *
     */
    CapEdge(CapNode n1, CapNode n2, String edgeName)
    {
     ...
     * @param n2 The point at the other end of the segment
     */
/*    CapEdge(String roadName, String roadType, CapNode n1, CapNode n2)
    {
     ...
     */
 /*   CapEdge(String roadName, String roadType,
            CapNode n1, CapNode n2, double length)
    {
    ...
    /**
     * return the CapNode for the end point
     * @return the CapNode for the end point
     */
    CapNode getEndNode() {
        return end;
