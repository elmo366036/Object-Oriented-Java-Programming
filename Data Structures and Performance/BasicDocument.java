...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		//System.out.print("\nNumber of Words: "+this.getTokens("[a-zA-Z]+").size());		
	    return this.getTokens("[a-zA-Z]+").size();
	    
	    //some issue with this.getTokens versus getTokens
	}
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		//System.out.print("\nNumber of Sentences: "+this.getTokens("[^.!?]+").size()+"\n");
	...
	public int getNumSyllables()
	{
		...
		//System.out.print("\nNumber of Syllables: "+numOfSyllables);
